...
ADBLOCK_SCRIPT := vendor/aospa/adaway/generate.py

TARGET_GENERATED_HOSTS_BLOCKER := $(TARGET_OUT_INTERMEDIATES)/ADBLOCK/hosts.aospa_adblock
...
include $(CLEAR_VARS)
LOCAL_MODULE := hosts.aospa_adblock
